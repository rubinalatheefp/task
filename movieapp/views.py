...
def add_movie(request):
    ...
    if request.method == "POST":
        ...
        movie = Movie(title=title, description=description, category=category, release_date=release_date, actors=actors,
                      poster=poster, trailer=trailer, author=author)
        movie.save()
...
def view_movie(request, pk, _already_reviewed=False):
    ...
    return render(request, "view_movie.html",
                  {"movie": movie, "reviews": reviews, "count": reviews_count, "curr_user_review": curr_user_review})
...
def edit_profile(request, pk):
    ...
    avatars = [
        "https://img.freepik.com/free-psd/3d-illustration-human-avatar-profile_23-2150671142.jpg?t=st=1715333046~exp=1715336646~hmac=e941db73c41712d97bfc01647685731931716d7f4460a130d20c786d0635a8f2&w=826",
